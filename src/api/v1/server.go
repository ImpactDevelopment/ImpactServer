...
func API(api *echo.Group) {
	...
	api.GET("/emailtest", emailTest, middleware.NoCache(), middleware.RequireAuth(), middleware.RequireRole("developer"))
	api.GET("/premiumcheck", premiumCheck, middleware.NoCache(), middleware.RequireAuth(), middleware.RequireRole("developer"))
	api.GET("/integration/impactbot/checkdonator/:discordid", checkDonator, middleware.NoCache(), middleware.RequireAuth(), middleware.RequireRole("developer"))
	api.GET("/integration/impactbot/genkey", genkey, middleware.NoCache(), middleware.RequireAuth(), middleware.RequireRole("developer"))
	api.GET("/integration/futureclient/masonlist", futureIntegration, middleware.NoCache(), middleware.RequireAuth(), middleware.RequireRole("future_dev"))
}
